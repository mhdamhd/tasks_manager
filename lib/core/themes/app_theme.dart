...
class AppTheme {
  ...
  final lightTheme = ThemeData.light().copyWith(
    ...
    //+2
    textTheme: TextTheme(
      displayLarge: TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w700, color: AppColors.white, fontFamily: _fontFamily),
      displayMedium: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w700, color: AppColors.white, fontFamily: _fontFamily),
      displaySmall: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, color: AppColors.white, fontFamily: _fontFamily),
      labelLarge: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w600, color: AppColors.white, fontFamily: _fontFamily),
      labelMedium: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500, color: AppColors.white, fontFamily: _fontFamily),
      labelSmall: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w500, color: AppColors.white, fontFamily: _fontFamily),
      titleLarge: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w400, color: AppColors.white, fontFamily: _fontFamily),
      titleMedium: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w400, color: AppColors.white, fontFamily: _fontFamily),
      titleSmall: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w400, color: AppColors.white, fontFamily: _fontFamily),
      bodyLarge: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w600, color: AppColors.white, fontFamily: _fontFamily),
